...
const connectDB = async ()=>{
    await mongoose.connect("mongodb+srv://Abhay:h3sDZY11CHNAryXA@namastenode.ij3gdlm.mongodb.net/devTinder");//if add the name of the specific database at the end of the url it will connect to that database
